...
public static class Extensions
{
    ...
    extension(IHostApplicationBuilder builder)
    {
        ...
        public IHostApplicationBuilder UseStrictServiceProviderValidation()
        {
            builder.ConfigureContainer(ServiceProviderValidation.CreateFactory());
            return builder;
        }

        private IHostApplicationBuilder AddSharedDefaults()
        {
        ...
        /// only by the deployed app, so <c>aspire run</c> keeps <c>AddSharedDefaults</c> + appsettings.
        /// </summary>
        private IHostApplicationBuilder AddAzureAppConfiguration()
        {
