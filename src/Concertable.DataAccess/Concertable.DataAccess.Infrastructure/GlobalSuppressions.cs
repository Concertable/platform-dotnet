...
[assembly: SuppressMessage("Design", "MA0053:Make class or record sealed", Scope = "type", Target = "~T:Concertable.DataAccess.Infrastructure.OutboxUnitOfWorkBehavior`1", Justification = "Generic base subclassed by per-module OutboxUnitOfWorkBehavior types in other service assemblies, which the analyzer cannot see.")]
