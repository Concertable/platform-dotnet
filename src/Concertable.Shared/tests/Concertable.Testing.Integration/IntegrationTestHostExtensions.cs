...
public static class IntegrationTestHostExtensions
{
    ...
    extension(IServiceCollection services)
    {
        ...
        public IServiceCollection AddXunitLogging(XunitOutputAccessor output)
        {
        ...
        public IServiceCollection AddTestAuthentication()
        {
        ...
        /// </summary>
        public IServiceCollection RemoveAzureServiceBus()
        {
